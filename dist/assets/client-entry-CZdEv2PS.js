...
function zwitch(key2, options) {
  ...
  function one2(value, ...parameters) {
    ...
    if (value && own$3.call(value, key2)) {
      ...
      fn = own$3.call(handlers2, id2) ? handlers2[id2] : one2.unknown;
    }
    if (fn) {
...
function root$3(node2, _, state, info) {
...
async function renderMarkdownToHtml(markdown) {
  ...
  try {
    const options = (_c = (_b = (_a = growiFacade == null ? void 0 : growiFacade.markdownRenderer) == null ? void 0 : _a.optionsGenerators) == null ? void 0 : _b.generateViewOptions) == null ? void 0 : _c.call(
      _b,
      "",
      { plantumlUri: null },
      () => {
...
//# sourceMappingURL=client-entry-CZdEv2PS.js.map
